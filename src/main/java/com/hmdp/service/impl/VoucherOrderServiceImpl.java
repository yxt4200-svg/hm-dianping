...
*/
    ...
    /**
     * 秒杀优化30：基于 Stream 消息队列实现异步秒杀（开启线程任务，从 Stream 收消息，完成下单）
     */
...
/*    // 从阻塞队列收消息
    ...
    /**
     * 秒杀优化30：基于 Stream 消息队列实现异步秒杀（修改lua脚本，判断抢购资格，向Stream发消息）
     */
    @Override
    public Result seckillVoucher(Long voucherId) {
        ...
        // 3.主线程获取代理对象，然后让子线程拿到代理对象：①传到阻塞队列②放入成员变量，这里用①见147行
